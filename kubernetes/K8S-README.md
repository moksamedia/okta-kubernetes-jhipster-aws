...
```
$ docker image tag gateway <your-docker-repository-name>/gateway
$ docker push <your-docker-repository-name>/gateway
$ docker image tag blog <your-docker-repository-name>/blog
$ docker push <your-docker-repository-name>/blog
$ docker image tag store <your-docker-repository-name>/store
$ docker push <your-docker-repository-name>/store
```
